...
$url        = 'https://github.com/MitMaro/git-interactive-rebase-tool/releases/download/1.1.0/git-interactive-rebase-tool-1.1.0-x86_64-pc-windows-msvc.zip' # download url, HTTPS preferred
...
git config --global core.editor "$installDir\interactive-rebase-tool.exe"
